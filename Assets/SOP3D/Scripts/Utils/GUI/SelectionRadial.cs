...
namespace Sop.Utils
{
    ...
    public class SelectionRadial : MonoBehaviour
    {
        ...
        public float m_SelectionDuration = 30f;                                                 // How long it takes for the bar to fill.
        ...
        Coroutine m_SelectionFillRoutine;                                                       // Used to start and stop the filling coroutine based on input.
        bool m_IsSelectionRadialActive;                                                         // Whether or not the bar is currently useable.
        bool m_RadialFilled;                                                                    // Used to allow the coroutine to wait for the bar to fill.
